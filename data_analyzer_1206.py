...
try:
    api_key = os.environ.get("CLAUDE_API_KEY", st.secrets.get("CLAUDE_API_KEY", None))
...
def generate_insights(df, context="single"):
    ...
    if context == "single":
        ...
        Provide:
        1. 4-5 key business insights
        2. 3-4 important metrics
        ...
        {{
            ...
            "metrics": [
                {{"name": "Metric Name", "calculation": "calculation", "description": "meaning"}}
            ],
            "visualizations": [
...
# Analysis Results
    ...
    if analysis_type == 'single':
        ...
        with st.spinner("Analyzing data..."):
            ...
            all_metrics = ai_metrics + calculated_metrics
            ...
            with kpi_cols[3]:
                ...
                if best_cat_col:
                    ...
                    st.metric(
                        ...
                        help="Number of categorical fields"
                    )
